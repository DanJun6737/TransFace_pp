...
def get_model_tiff(name, **kwargs):
    # resnet
    if name == "r18":
        ...
        from .vit_tiff import VisionTransformer
...
def get_model_png(name, **kwargs):
    ...
    if name == "r18":
        ...
        from .vit_png import VisionTransformer
...
def get_model_fchw(name, **kwargs):
    # resnet
    if name == "r18":
        return iresnet18(False, **kwargs)
    elif name == "r34":
        ...
        from .vit_fchw import VisionTransformer
...
def get_model_fhwc(name, **kwargs):
    # resnet
    if name == "r18":
        return iresnet18(False, **kwargs)
    elif name == "r34":
        ...
        from .vit_fhwc import VisionTransformer
