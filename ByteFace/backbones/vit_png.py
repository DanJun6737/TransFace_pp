...
class PatchEmbed(nn.Module):
    def __init__(self, img_size=108, patch_size=9, in_channels=3, embed_dim=768):
        ...
        self.topo_conv=nn.Conv1d(in_channels=512, out_channels=3, kernel_size=30, stride=6)
    ...
    def forward(self, x, phase="train"):
        ...
        topo_feature = torch.stack(topo_information)   
        
        topo_all_fea_before = self.topo_increase(topo_feature).reshape(x.shape[0],144,512)
...
class VisionTransformer(nn.Module):
    ...
    def random_masking(self, x, topo_all_fea, mask_ratio=0.1):
        ...
        #return x_masked, mask, ids_restore  ## original
